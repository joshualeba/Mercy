document.addEventListener('DOMContentLoaded', () => {
    const chatbotContainer = document.getElementById('bankChatbotContainer');
    ...
    let usedQuestions = [];
    try {
        usedQuestions = JSON.parse(localStorage.getItem('bank_used_questions') || '[]');
    } catch (e) { }
    ...
    function renderQuickActions() {
        ...
        if (usedQuestions.length >= allQuestions.length) {
            usedQuestions = [];
            localStorage.setItem('bank_used_questions', '[]');
        }
        ...
        currentShownQuestions.forEach(q => {
            ...
            btn.onclick = (e) => {
                ...
                localStorage.setItem('bank_used_questions', JSON.stringify(usedQuestions));
