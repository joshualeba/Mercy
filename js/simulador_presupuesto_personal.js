...
window.descargarPDFPresupuesto = function (event) {
    ...
    if (typeof window.jsPDF !== 'undefined') {
        ...
        if (typeof aplicarEstiloPDFBankario === 'function') {
            aplicarEstiloPDFBankario(doc, 'Proyección de Presupuesto Personal');
        } else {
            doc.setFontSize(18);
        ...
        doc.save('BANKario_Proyeccion_Presupuesto.pdf');
    } else {
