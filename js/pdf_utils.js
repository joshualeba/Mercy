// Función centralizada para aplicar marca de agua, headers y footers estilo BANKario
function aplicarEstiloPDFBankario(doc, titulo) {
    ...
    const textW = doc.getTextWidth("BANKARIO");
    doc.text("BANKARIO", (pageWidth - textW) / 2 + 30, pageHeight / 2 + 30, { angle: 45 });
    ...
    if (typeof MERCY_LOGO_B64 !== 'undefined') {
        ...
        doc.setFontSize(22);
        doc.text("BANKARIO", 38, 20);
    } else {
        doc.setTextColor(255, 255, 255);
        doc.setFontSize(22);
        doc.text("BANKARIO", 15, 20);
    }
    ...
    doc.text("Generado por BANKario - Plataforma de Educación Financiera", pageWidth / 2, pageHeight - 10, { align: 'center' });
}
